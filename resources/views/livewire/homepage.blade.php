  ...
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      ...
      <p class="mb-12 text-base text-center text-gray-500">
        Lorem ipsum, sit amet in a world full of wonders. Could greatness be near? Perhaps hidden, perhaps fleeting, yet always tempting us with desire
      </p>
    </div>
  </div>
...
<div class="bg-orange-200 py-20">
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      ...
      <p class="mb-12 text-base text-center text-gray-500">
        Lorem ipsum, in a world of endless wonders, what grand surprises await? Perhaps hidden, perhaps fleeting, yet always calling to our curiosity
      </p>
    </div>
  </div>
  ...
  <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        ...
        <p class="mb-12 text-base text-center text-gray-500">
          Suddenly, a spark of wonder appears—how often do we stumble upon moments of unexpected joy, hidden in plain sight?
        </p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
      <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
        ...
        <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
          Every moment holds its own value, and even the smallest deeds can leave lasting marks on life’s path.
        </p>
      ...
      <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
        ...
        <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
          Pain and pleasure intertwine in life’s journey. Yet, rare are the moments that truly define our path.
        </p>
        <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
          <div class="flex px-6 mb-2 md:mb-0">
            <ul class="flex items-center justify-start mr-4">
      ...
      <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
        ...
        <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
          Moments of chance collide with hidden truths, shaping paths we scarcely notice yet cannot ignore.
        </p>
        <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
          <div class="flex px-6 mb-2 md:mb-0">
            <ul class="flex items-center justify-start mr-4">
      ...
      <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
        ...
        <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
            Curiosity leads the mind through hidden paths, revealing truths that patience alone can uncover.
        </p>
        <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
          <div class="flex px-6 mb-2 md:mb-0">
            <ul class="flex items-center justify-start mr-4">
